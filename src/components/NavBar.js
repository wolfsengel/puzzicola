          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                <a href="https://www.linkedin.com/company/puzzi-cola-publi"><img src={navIcon1} alt="" /></a>
                <a href="https://www.facebook.com/share/1A8sU7nHyB/?mibextid=wwXIfr"><img src={navIcon2} alt="" /></a>
                <a href="https://www.instagram.com/puzzi.cola.publi/"><img src={navIcon3} alt="" /></a>
              </div>
              <HashLink to='#connect'>
